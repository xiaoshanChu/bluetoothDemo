...
import com.seller.yhj.volley.Response.ErrorListener;
import com.seller.yhj.volley.Response.Listener;
import com.seller.yhj.volley.VolleyError;
...
public class ImageLoader {
    ...
    public static ImageListener getImageListener(final ImageView view,
        ...
        return new ImageListener() {
            ...
            public void onResponse(ImageContainer response, boolean isImmediate) {
                if (response.getBitmap() != null && !response.getBitmap().isRecycled()) {
     ...
     */
    public ImageContainer get(String requestUrl, final ImageListener listener,int angle) {
        return get(requestUrl, listener, 0, 0,angle);
    }
    ...
    public ImageContainer get(String requestUrl, ImageListener imageListener,
            int maxWidth, int maxHeight,int angle) {
