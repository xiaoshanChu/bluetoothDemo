...
public class HurlStack implements HttpStack {
    ...
    public HurlStack(Context context) {
    	sslSocketFactory = HttpUrlConnectionSSlSocketFactory.getSSlSocketFactory(context);
    }
    ...
    public HttpResponse performRequest(Request<?> request, Map<String, String> additionalHeaders)
        ...
        if ("https".equals(parsedUrl.getProtocol()) && sslSocketFactory != null) {
        	protocolVersion = new ProtocolVersion("HTTPS", 1, 1);
        }else{
     ...
     * @throws IOException
     */
    private HttpURLConnection openConnection(URL url, Request<?> request) throws Exception {
...
//                            request.getPostBodyContentType());
            ...
            case Method.PICTURE:
            	connection.setRequestMethod("POST");
            	addBodyIfExistsPicture(connection, request);
            	break;
            default:
    ...
    private static void addBodyIfExistsPicture(HttpURLConnection connection, Request<?> request)
            throws IOException {
...
//            connection.addRequestProperty(HEADER_CONTENT_TYPE, request.getBodyContentType());
    ...
    private static void addFileBody(HttpURLConnection connection, Request<?> request)
    		throws IOException {
    	File file = request.getFileBody();
